 ...
 *
 * @WebformElement(
 *   id = "person_organisation_adresse_element",
 *   label = @Translation("Person Organisation Address Element"),
 *   description = @Translation("Person Organisation Address Element description"),
 *   category = @Translation("Organisation")
 * )
 */
class PersonOrganisationAddressElement extends TextField {
  ...
  public function finalize(array &$element, WebformSubmissionInterface $webform_submission = NULL) {
    $element['#value'] = $this->helper->getOrganisationAddress();
